...
class PipermailBackendTest(unittest.TestCase):
    ...
    def test_get_links(self):
        ...
        self.assertIn("https://mail.kde.org/pipermail/k3b/2011-February.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2011-March.txt.gz", links)
        ...
        self.assertIn("https://mail.kde.org/pipermail/k3b/2011-July.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2011-August.txt.gz", links)
        ...
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-January.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-February.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-February.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-March.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-April.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-May.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-June.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2012-July.txt.gz", links)
        ...
        self.assertIn("https://mail.kde.org/pipermail/k3b/2013-January.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2013-February.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2013-February.txt.gz", links)
        ...
        self.assertIn("https://mail.kde.org/pipermail/k3b/2013-June.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2013-July.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2013-August.txt.gz", links)
        ...
        self.assertIn("https://mail.kde.org/pipermail/k3b/2013-December.txt.gz", links)
        ...
        self.assertIn("https://mail.kde.org/pipermail/k3b/2014-April.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2014-May.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2014-June.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2014-July.txt.gz", links)
        self.assertIn("https://mail.kde.org/pipermail/k3b/2014-August.txt.gz", links)
