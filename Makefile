...
deploy:
	...
	@echo
	@echo "Build finished. The HTML pages are in $(BUILDDIR)."
	git push -fq https://$(TRAVIS_GH_TOKEN)@github.com/smartshark/mailingSHARK.git gh-pages
	@echo
	@echo "Push finished. The HTML pages are pushed to https://smartshark.github.io/mailingSHARK/"